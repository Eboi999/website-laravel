						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								...
								<div class="single-info">
									...
									<ul>
										<li>clarencedave.banagaso@hcdc.edu.ph</li>
									</ul>
								</div>
								<div class="single-info">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Complete-Ecommerce-in-laravel-10-master\resources\views/frontend/pages/contact.blade.php ENDPATH**/ ?>